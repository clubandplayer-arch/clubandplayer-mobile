import { CATEGORIES_BY_SPORT } from "../opportunities/formOptions";
...
export const EMPTY_PAST_EXPERIENCE: PastExperience = {
  season: "",
  club: "",
  sport: "",
  category: "",
...
export const CLUB_SPORT_OPTIONS = Object.keys(CATEGORIES_BY_SPORT).filter((sport) => sport !== "Pallavolo");
